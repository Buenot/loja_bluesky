...
<div style= "background-color:black;" >
  ...
  <main class="" style= "background-color:black;">
    <div class="container col-12" style= "background-color:black;">
      ...
      <h2 class="mb-3 d-flex align-items-start" style= "font-size:1.8rem; color:white; font-family:'Roboto Slab', serif;">Moletons Bluesky</h2>

        <!--Card compra moletons-->
          ...
          <div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
              <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                <img src="../mdb/img/moletons/{{$product->id}}.jpg" class="img-fluid" />
                <a href="#!">
              ...
              <div class="card-body" style="background-color: rgba(  3, 152, 158 );">
                ...
                @csrf
                  <input type="hidden" name="idProduct" value={{$product->id}} />
                  <button type="submit" class="btn" style="color:rgba(  3, 152, 158  ); background-color:white; font-size:0.7rem;font-family:'Roboto Slab', serif;">adcionar ao carrinho</button>
                </form>
              </div>
            </div>
          </div>
